    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-900 via-cyan-900 to-blue-900 flex items-center justify-center p-4">
      <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 w-full max-w-md border-2 border-teal-500/50">
        <div className="text-center mb-8">
          ...
          <p className="text-teal-300">Estimate user stories together in real-time</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-teal-500/50 rounded-lg bg-slate-700/50 text-teal-100 focus:ring-2 focus:ring-teal-400 focus:border-teal-400 outline-none placeholder-teal-400"
              onKeyPress={(e) => {
          ...
          <div className="flex flex-col gap-3 pt-4">
            <button
              ...
              className="w-full bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-500 hover:to-cyan-500 text-white font-semibold py-3 px-4 rounded-lg transition-all transform hover:scale-105 shadow-lg"
            >
              Create New Room
            </button>
            {roomId && (
